...
<div className="my-6">
  <div className="grid sm:grid-cols-2 items-start gap-14 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
    <div>
    <img src="/logo.svg" className="w-72 h-32 rounded-full object-cover border-8 border-white" alt="img" />
      <div className="mt-12">
        <h2 className="text-gray-800 text-base font-bold">Email</h2>
        <ul className="mt-4">
          <li className="flex items-center">
            <div className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="#809C5C" viewBox="0 0 479.058 479.058">
            ...
            <a href="javascript:void(0)" className="text-[#809C5C] text-sm ml-4">
        ...
        <ul className="flex mt-4 space-x-4">
          <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
            <a href="javascript:void(0)">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="#809C5C" viewBox="0 0 24 24">
          ...
          <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
            <a href="javascript:void(0)">
              <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="#809C5C" viewBox="0 0 511 512">
    ...
    <form className="ml-auo space-y-4">
      <input type="text" placeholder="Prenom et Nom" className="w-full text-gray-800 rounded-md py-2.5 px-4 border text-sm outline-[#809C5C]" />
      <input type="email" placeholder="Email" className="w-full text-gray-800 rounded-md py-2.5 px-4 border text-sm outline-[#809C5C]" />
      <input type="text" placeholder="Sujet" className="w-full text-gray-800 rounded-md py-2.5 px-4 border text-sm outline-[#809C5C]" />
      <textarea placeholder="Message" rows={6} className="w-full text-gray-800 rounded-md px-4 border text-sm pt-2.5 outline-[#809C5C]" defaultValue={""} />
      <button type="button" className="text-white bg-[#809C5C] hover:bg-[#809C5C] rounded-md text-sm px-4 py-3 w-full !mt-6">Envoyer</button>
    </form>
  </div>
</div>
