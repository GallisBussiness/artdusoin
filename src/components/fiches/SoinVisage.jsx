            ...
            PLAN DE FORMATION SOIN VISAGE 
              ...
              <div className="my-3 py-3">
                   ...
                   <ul className="pl-10">
                       ...
                       <li> - La peau</li>
                       <li> - Le matériel</li>
                       <li> - Les différents types de peau</li>
                       <li> - La préparation de la cabine</li>
                       <li> - Les différents types de soins</li>
                   ...
                   <ul className="pl-10">
                       ...
                       <li> - Pratique d’un soin en binôme</li>
                       <li> - Points sur les enseignements de la journée</li>
                   </ul>
              </div>
              <div className="my-3 py-3">
                   ...
                   <ul className="pl-10">
                       ...
                       <li> - Utilisation du vapozone</li>
                       <li> - Extraction des comédons</li>
                       <li> - Modelage visage</li>
                       <li> - Masque</li>
                       <li> - Pratique avec optimisation du temps de réalisation</li>
              ...
              <div className="my-3 py-3">
                   ...
                   <ul className="pl-10">
                       ...
                       <li> - Préparation d’une fiche cliente</li>
                       <li> - Préparation d’un plan travail</li>
                       <li> - Diagnostique de peau</li>
                       <li> - Déroulement d’un soin</li>
                   </ul>
              </div>
          </div>  
        </>
