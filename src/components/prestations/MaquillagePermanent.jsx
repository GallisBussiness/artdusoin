...
function MaquillagePermanent() {
    const soins = [
      { nom: "Sourcils", duree: "1h 30 min", prix: "290 €" },
      { nom: "Lèvres", duree: "1h 30 min", prix: "290 €" },
      { nom: "Eye Liner", duree: "1h 30 min", prix: "290 €" },
      { nom: "Retouche", duree: "1h", prix: "145 €" },
      { nom: "Grains de Beauté", duree: "20 min", prix: "50 €" },
      { nom: "Tatouage Personnalisé", duree: "20 min", prix: "50 €" },
    ]
