    ...
    <div className="text-center p-6 flex flex-col justify-center items-center">
      ...
      <ul className="flex flex-wrap justify-center gap-6 mt-8">
        <li className="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill="#789757" viewBox="0 0 482.6 482.6">
          ...
          <div className="text-[#789757] text-sm ml-2">+33 785 153 621</div>
        </li>
        <li className="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill="#789757" viewBox="0 0 479.058 479.058">
          ...
          <div className="text-[#789757] text-sm ml-2">karina.chirara@gmail.com</div>
        </li>
      </ul>
    </div>
    <div className="flex justify-end items-center p-2 bg-gradient-to-b from-[#789757] to-[#fbe094cc] rounded-bl-[230px] w-full h-full">
      <div className="h-72 w-72 rounded-full bg-gradient-to-tr from-[#789757] to-[#fbe094cc] p-5">
        <img src="/logo.svg" className="w-full h-full rounded-full object-cover border-8 border-white" alt="img" />
      </div>
    </div>
  </div>
  <div className="absolute -top-[50px] -left-[50px] w-28 h-28 rounded-full bg-[#789757] opacity-40 shadow-lg" />
  <div className="absolute -top-10 -left-10 w-28 h-28 rounded-full bg-[#789757] opacity-40 shadow-lg" />
</div>
